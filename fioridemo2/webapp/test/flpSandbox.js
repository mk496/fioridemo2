		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#fioridemo2fioridemo2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioridemo2fioridemo2-display": {
								"semanticObject": "fioridemo2fioridemo2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioridemo2.fioridemo2",
									"url": sap.ui.require.toUrl("fioridemo2/fioridemo2")
								}
							}
						}
					}
